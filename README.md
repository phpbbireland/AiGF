...
My method was simple, build initial working example and then add more functionality in stages testing before continuing.  
Test and verify code is working without errors before adding next steps...  
